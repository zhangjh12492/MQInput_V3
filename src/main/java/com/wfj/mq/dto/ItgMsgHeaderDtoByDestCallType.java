...
import com.wfj.utils.FieldsAnnoatation.FieldDesc;

/**
 * Created by MaYong on 2014/12/18.
 */
public class ItgMsgHeaderDtoByDestCallType {
    @FieldDesc(DESC = "版本号")
    private String version;
    @FieldDesc(DESC = "业务系统编码")
    private String sourceSysID;
    @FieldDesc(DESC = "业务对象服务编码")
    private String serviceID;
    @FieldDesc(DESC = "优先级")
    private String priority;
    @FieldDesc(DESC = "数量")
    private String count;
    @FieldDesc(DESC = "业务类别编码")
